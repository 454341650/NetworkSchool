...
(function($) {
	$.LocationSelect = {
		defaults : {
				data: web_url+"/jslib/area/areas.json",
				autoDetect : false
		},
		build : function(user_opts) {
			...
			return $(this).each(function() {
				...
				specs.holder.append('<select name="province" id="province"><option value="0">选择省</option></select><select name="city" id="city"><option value="0">选择市</option></select><select name="district" id="district"><option value="0">选择区</option></select>');
				try{
