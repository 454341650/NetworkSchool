...
var webFXTreeConfig = {		
	...
	fileIcon        : this.imagePath + '/symptom.jpg',
	...
	setImagePath: function(path,str){  // 设置图片路径。直接设置 imagePath 属性不起作用。
...
function setImage(str){
	if(str!=null)webFXTreeConfig.fileIcon=webFXTreeConfig.imagePath +'/'+str;
}
